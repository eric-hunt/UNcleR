...
```{r}
consolidate_experiments <- function(run_info, experiments, join_vars = NULL, legacy = FALSE, SLSheader = TRUE, DLSheader = FALSE) {
  meta <- run_info
...
```{r}
test <- consolidate_experiments(run_info, experiments)
```
