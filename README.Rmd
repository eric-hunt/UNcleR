...
* `import_DLSspec()` imports DLS intensity or mass distribution spectra
* `import_SLSsum()` imports SLS and thermal ramp summary data
* `import_SLSspec` imports raw SLS spectral data at a specified wavelength
...
* `get_metadata` imports metadata from an Excel document into a list of dataframes
